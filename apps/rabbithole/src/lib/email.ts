    ...
    return wrapEmail(
      ...
      <tr>
        <td style="padding:40px;">
          ...
          <div style="text-align:center; margin-bottom:16px;">
            ${ctaButton('Resubscribe', 'https://rabbithole.inc/pricing')}
          </div>
          <p style="margin:0; color:#9090a0; font-size:13px; text-align:center;">
...
Resubscribe: https://rabbithole.inc/pricing
    ...
    return wrapEmail(
      ...
      <tr>
        <td style="padding:40px;">
          ...
          <div style="text-align:center; margin-bottom:16px;">
            ${ctaButton('Visit Rabbit Hole', 'https://rabbithole.inc')}
          </div>
        </td>
      </tr>
      ${brandFooter()}
...
Visit Rabbit Hole: https://rabbithole.inc
