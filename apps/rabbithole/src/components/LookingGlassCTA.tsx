                        ...
                        <defs>
                            <linearGradient id="portalGradient" x1="0%" y1="0%" x2="100%" y2="100%">
                                <stop offset="0%" stopColor="#00f5ff" stopOpacity="0.8">
                                    <animate attributeName="stop-color" values="#00f5ff;#8b5cf6;#ff00f5;#00f5ff" dur="3s" repeatCount="indefinite" />
                                </stop>
                                <stop offset="100%" stopColor="#8b5cf6" stopOpacity="0.6">
                                    <animate attributeName="stop-color" values="#8b5cf6;#ff00f5;#00f5ff;#8b5cf6" dur="3s" repeatCount="indefinite" />
                                </stop>
                            </linearGradient>
