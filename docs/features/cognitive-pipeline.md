...
| Recall | `MemoryRouter` | `@framers/agentos/memory-router` | [Memory Router](/features/memory-router) |
...
| Read | `ReadRouter` | `@framers/agentos/read-router` | [Read Router](/features/read-router) |
