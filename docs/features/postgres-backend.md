...
Full architecture lives in the internal design spec at `packages/agentos/docs/superpowers/specs/2026-04-26-brain-storage-abstraction-design.md` (not published to the docs site).
