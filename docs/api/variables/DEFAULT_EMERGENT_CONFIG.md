# Variable: DEFAULT\_EMERGENT\_CONFIG

> `const` **DEFAULT\_EMERGENT\_CONFIG**: `Readonly`\<[`EmergentConfig`](../interfaces/EmergentConfig.md)\>

Defined in: [packages/agentos/src/emergent/types.ts:752](https://github.com/framersai/agentos/blob/ac1e60f8857aef619a8160a2a7cfc7a63e5ee780/src/emergent/types.ts#L752)
