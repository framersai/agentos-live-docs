...
\{ `durationMs`: `number`; `nodeId`: `string`; `output`: `unknown`; `telemetry?`: [`NodeTelemetry`](../interfaces/NodeTelemetry.md); `type`: `"node_end"`; \}
...
> `optional` **telemetry**: [`NodeTelemetry`](../interfaces/NodeTelemetry.md)
...
\{ `guardrailId`: `string`; `nodeId`: `string`; `reason`: `string`; `type`: `"guardrail:hitl-override"`; \}
