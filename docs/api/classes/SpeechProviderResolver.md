...
Defined in: [packages/agentos/src/io/speech/SpeechProviderResolver.ts:69](https://github.com/framersai/agentos/blob/63ed327fe991cbf5fe1e01bca76416a3aaa76167/src/io/speech/SpeechProviderResolver.ts#L69)
...
3. **Requirements matching** — Optional [ProviderRequirements](../interfaces/ProviderRequirements.md) further
...
5. **Fallback wrapping** — When `config.stt.fallback` or `config.tts.fallback`
   ...
   [FallbackSTTProxy](FallbackSTTProxy.md) or [FallbackTTSProxy](FallbackTTSProxy.md) that tries each in
...
## See
 ...
 - [FallbackSTTProxy](FallbackSTTProxy.md) for the STT fallback chain implementation
 - [FallbackTTSProxy](FallbackTTSProxy.md) for the TTS fallback chain implementation
 - [ProviderRequirements](../interfaces/ProviderRequirements.md) for available filtering criteria
...
Defined in: [packages/agentos/src/io/speech/SpeechProviderResolver.ts:95](https://github.com/framersai/agentos/blob/63ed327fe991cbf5fe1e01bca76416a3aaa76167/src/io/speech/SpeechProviderResolver.ts#L95)
...
Optional resolver configuration controlling preferred
...
Defined in: [packages/agentos/src/io/speech/SpeechProviderResolver.ts:146](https://github.com/framersai/agentos/blob/63ed327fe991cbf5fe1e01bca76416a3aaa76167/src/io/speech/SpeechProviderResolver.ts#L146)
...
Defined in: [packages/agentos/src/io/speech/SpeechProviderResolver.ts:307](https://github.com/framersai/agentos/blob/63ed327fe991cbf5fe1e01bca76416a3aaa76167/src/io/speech/SpeechProviderResolver.ts#L307)
...
Optional object exposing `getDescriptorsByKind(kind)`.
...
Defined in: [packages/agentos/src/io/speech/SpeechProviderResolver.ts:124](https://github.com/framersai/agentos/blob/63ed327fe991cbf5fe1e01bca76416a3aaa76167/src/io/speech/SpeechProviderResolver.ts#L124)
...
The full registration object including the provider instance,
...
Defined in: [packages/agentos/src/io/speech/SpeechProviderResolver.ts:179](https://github.com/framersai/agentos/blob/63ed327fe991cbf5fe1e01bca76416a3aaa76167/src/io/speech/SpeechProviderResolver.ts#L179)
...
them in a [FallbackSTTProxy](FallbackSTTProxy.md) that tries providers in priority order.
...
Optional filtering criteria (streaming, local, features,
  preferredIds).
...
#### See
 ...
 - [FallbackSTTProxy](FallbackSTTProxy.md) for fallback chain behaviour
 - [ProviderRequirements](../interfaces/ProviderRequirements.md) for available filter options
...
Defined in: [packages/agentos/src/io/speech/SpeechProviderResolver.ts:217](https://github.com/framersai/agentos/blob/63ed327fe991cbf5fe1e01bca76416a3aaa76167/src/io/speech/SpeechProviderResolver.ts#L217)
...
them in a [FallbackTTSProxy](FallbackTTSProxy.md) that tries providers in priority order.
Otherwise returns the single highest-priority match.
...
#### See
 ...
 - [FallbackTTSProxy](FallbackTTSProxy.md) for fallback chain behaviour
 - [ProviderRequirements](../interfaces/ProviderRequirements.md) for available filter options
...
Defined in: [packages/agentos/src/io/speech/SpeechProviderResolver.ts:249](https://github.com/framersai/agentos/blob/63ed327fe991cbf5fe1e01bca76416a3aaa76167/src/io/speech/SpeechProviderResolver.ts#L249)
...
Defined in: [packages/agentos/src/io/speech/SpeechProviderResolver.ts:274](https://github.com/framersai/agentos/blob/63ed327fe991cbf5fe1e01bca76416a3aaa76167/src/io/speech/SpeechProviderResolver.ts#L274)
...
[`WakeWordProvider`](../interfaces/WakeWordProvider.md) \| `null`
