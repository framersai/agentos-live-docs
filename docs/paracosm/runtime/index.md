...
- [EventDirector](classes/EventDirector.md)

## Interfaces

- [BatchConfig](interfaces/BatchConfig.md)
- [BatchManifest](interfaces/BatchManifest.md)
- [BatchResult](interfaces/BatchResult.md)
- [CommanderDecision](interfaces/CommanderDecision.md)
- [CrisisResearchPacket](interfaces/CrisisResearchPacket.md)
- [DepartmentReport](interfaces/DepartmentReport.md)
- [DirectorContext](interfaces/DirectorContext.md)
- [DirectorEvent](interfaces/DirectorEvent.md)
...
- [~~CrisisCategory~~](type-aliases/CrisisCategory.md)
...
- [getDepartmentsForTurn](functions/getDepartmentsForTurn.md)
- [recordReactionMemory](functions/recordReactionMemory.md)
- [resolveEconomicsProfile](functions/resolveEconomicsProfile.md)
- [runBatch](functions/runBatch.md)
- [runSimulation](functions/runSimulation.md)
- [updateRelationshipsFromReactions](functions/updateRelationshipsFromReactions.md)
