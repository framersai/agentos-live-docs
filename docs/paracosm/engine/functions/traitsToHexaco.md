...
> **traitsToHexaco**(`traits`): [`HexacoProfile`](../interfaces/HexacoProfile.md)

Defined in: [apps/paracosm/src/engine/trait-models/normalize-leader.ts:147](https://github.com/framersai/paracosm/blob/4b7d109255db6541b63aff869511eecf9500ee08/src/engine/trait-models/normalize-leader.ts#L147)
