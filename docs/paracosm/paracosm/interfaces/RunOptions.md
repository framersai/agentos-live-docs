...
Defined in: [apps/paracosm/src/api/types.ts:38](https://github.com/framersai/paracosm/blob/902b79ee37e51444458d39152e6844a2c10a050e/src/api/types.ts#L38)

Options accepted by the top-level `run(prompt, opts)` function.

## Extended by

- [`RunManyOptions`](RunManyOptions.md)
