# Function: swarmByDepartment()

> **swarmByDepartment**(`artifact`): `Record`\<`string`, [`SwarmAgent`](../../schema/type-aliases/SwarmAgent.md)[]\>

Defined in: [apps/paracosm/src/runtime/swarm/index.ts:41](https://github.com/framerslab/paracosm/blob/8887b389ebb1029adcd45226dfa95c344c2100ba/src/runtime/swarm/index.ts#L41)
