...
const mockRetrievalAugmentor: IRetrievalAugmentor = {
  augmenterId: 'ra-mock',
  initialize: vi.fn().mockResolvedValue(undefined),
  ingestDocuments: vi.fn().mockResolvedValue({ ingestedDocumentIds: [], processedDocumentCount: 0, successfullyIngestedCount: 0, failedIngestionCount: 0, errors: [] }),
  ...
  updateDocuments: vi.fn().mockResolvedValue({ ingestedDocumentIds: [], processedDocumentCount: 0, successfullyIngestedCount: 0, failedIngestionCount: 0, errors: [] }),
  checkHealth: vi.fn().mockResolvedValue({ isHealthy: true }),
  shutdown: vi.fn().mockResolvedValue(undefined),
};
