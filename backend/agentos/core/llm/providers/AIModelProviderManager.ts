...
import { GMIError, GMIErrorCode, createGMIErrorFromError } from '../../../../utils/errors'; // Corrected import path
...
      throw new GMIError( // Changed from generic Error to GMIError
        'AIModelProviderManager is not initialized. Call initialize() first.',
        GMIErrorCode.NOT_INITIALIZED, // Using an appropriate error code
        undefined,
        { component: 'AIModelProviderManager' }
      );
    }
  }
