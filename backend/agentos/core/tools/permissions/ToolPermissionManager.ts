...
 * @see {@link ../../../../utils/errors.ts} for `GMIError` and `GMIErrorCode`.
 */
...
    try {
      const userTier: ISubscriptionTier | null = await this.subscriptionService.getUserSubscriptionTier(userId);
