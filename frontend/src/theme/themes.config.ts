 ...
 * @version 3.2.1 - Simplified Terminus theme IDs to 'terminus-dark' and 'terminus-light'.
 */
...
export interface ThemeCssVariableMap {
  ...
  '--color-danger-h'?: string; '--color-danger-s'?: string; '--color-danger-l'?: string; '--color-danger-a'?: string;
  '--color-danger-text-h'?: string; '--color-danger-text-s'?: string; '--color-danger-text-l'?: string; '--color-danger-text-a'?: string;
...
export const availableThemes: readonly ThemeDefinition[] = [
  ...
  {
    id: 'terminus-dark', // UPDATED ID
    name: '🕹️ Terminus Dark', // UPDATED Name
    isDark: true,
    energy: 'agnostic',
    cssVariables: {
  ...
  {
    id: 'terminus-light', // UPDATED ID
    name: '⌨️ Terminus Light', // UPDATED Name
    isDark: false,
    energy: 'agnostic',
    cssVariables: {
      '--font-family-sans': 'var(--font-family-retro-sans, "IBM Plex Mono", "Fira Code", monospace)',
      ...
      '--color-text-primary-h': 'var(--terminal-green-h, 120)',
      '--color-text-primary-s': 'var(--terminal-green-s, 85%)', // Assuming darker phosphor variant
      '--color-text-primary-l': 'var(--terminal-green-l, 30%)',  // for light bg
      '--color-accent-primary-h': 'var(--terminal-green-h, 120)',
