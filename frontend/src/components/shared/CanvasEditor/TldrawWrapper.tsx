...
import { Tldraw, TLUiOverrides, Editor, exportToBlob, exportToSvg } from 'tldraw'
 ...
 * ```
 */
const TldrawWrapper = forwardRef<TldrawWrapperHandle, TldrawWrapperProps>(
    ...
    const exportToSVG = useCallback(
      async (options: CanvasExportOptions = {}): Promise<string | null> => {
        ...
        try {
          ...
          const svg = await exportToSvg(editor, [...shapeIds], {
