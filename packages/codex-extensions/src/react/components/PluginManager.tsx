...
import type { PluginManifest, PluginState, Theme, ThemeManifest } from '../../types';
...
export function PluginManager({
  ...
  // Handlers
  const handleTogglePlugin = useCallback(async (id: string) => {
        ...
        <div className="flex flex-1 overflow-hidden">
          ...
          `}>
            ...
            <nav className="px-2 pb-4">
              <div className={`text-xs font-medium uppercase tracking-wider px-2 py-2 ${isDark ? 'text-zinc-500' : 'text-zinc-400'}`}>
                Filter
              </div>
              ...
              <div className={`text-xs font-medium uppercase tracking-wider px-2 py-2 mt-4 ${isDark ? 'text-zinc-500' : 'text-zinc-400'}`}>
                Categories
              </div>
